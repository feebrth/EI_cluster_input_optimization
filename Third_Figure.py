...
grid = fig.add_gridspec(5, 5, left=0.10, right= 0.95, height_ratios=[4.0, 0.1, 1.5, 2.3, 2.3], hspace=0.4, wspace=0.3)
...
fig.legend(handles=handles, loc="lower center", ncol=3, fontsize=24, frameon=False, bbox_to_anchor=(0.5, -0.02))
...
plt.savefig("Third_Figure_test92.png", dpi=300)
