...
for col, (trial, label) in enumerate(zip(selected_trials, labels)):
    ...
    axs_fr.plot(exp_time_rates, exp_delta_rates, label=r'Experimental $\Delta$  FR [spike/s]', linestyle="--", color="red")
...
handles_fr, labels_fr = axs_fr.get_legend_handles_labels()
handles_ff, labels_ff = axs_ff.get_legend_handles_labels()
