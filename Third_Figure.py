...
fig.text(x_position, 0.85, "(a)", fontsize=16, fontweight="bold", ha="left", va="center", rotation=0)
fig.text(x_position, 0.70, "(b)", fontsize=16, fontweight="bold", ha="left", va="center", rotation=0)
fig.text(x_position, 0.63, "(c)", fontsize=16, fontweight="bold", ha="left", va="center", rotation=0)
fig.text(x_position, 0.35, "(d)", fontsize=16, fontweight="bold", ha="left", va="center", rotation=0)
